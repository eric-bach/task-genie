        ...
        <section className='overflow-hidden bg-white dark:bg-transparent'>
          <div className='relative mx-auto max-w-5xl px-6 py-28 lg:py-24'>
            <div className='relative z-10 mx-auto max-w-2xl text-center'>
              <h1 className='text-balance text-4xl font-semibold md:text-5xl lg:text-6xl'>Agile Made Effortless</h1>
              <p className='mx-auto my-8 max-w-2xl text-xl'>
                Simplify user story creation and task breakdown with AI-powered precision for faster, smarter sprints.
              </p>
          ...
          <div className='mx-auto -mt-16 max-w-7xl'>
            <div className='perspective-distant -mr-16 pl-16 lg:-mr-56 lg:pl-56'>
              <div className='[transform:rotateX(20deg);]'>
                <div className='lg:h-126 relative skew-x-[.36rad]'>
