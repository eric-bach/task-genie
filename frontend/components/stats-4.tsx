    ...
    <section className='py-16 md:py-32'>
      <div className='mx-auto max-w-5xl space-y-8 px-6 md:space-y-12'>
        <div className='relative z-10 max-w-xl space-y-6'>
          ...
          <p>Empower your team with AI-driven tools designed to make Agile planning faster, more efficient, and stress-free.</p>
        </div>
        <div className='grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24'>
          <div>
            <p>AI-powered user story creation, seamless task breakdown, customizable workflows, time-saving automation, and collaboration made easy</p>
          ...
          <div className='relative'>
            <blockquote className='border-l-4 pl-4'>
              <p>
                This app has completely transformed how we approach sprint planning. It’s like having an extra team member who never gets tired of organizing
                our work!
              </p>
