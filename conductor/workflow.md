...
8. **Defer Code Changes to Phase Completion:**
   - Code changes related to the task are staged but not committed individually. They will be included in the phase-level commit.

9. **Record Task Completion:**
    - Update `plan.md` to mark the task as `[x]`. (The commit for this will happen at phase end).
