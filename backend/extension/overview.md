# Task Genie - AI-Powered Agile Work Item Assistant

Transform your Azure DevOps workflow with intelligent work item validation and automatic child work item generation.
...
- ✅ Reduce manual effort in multi-level backlog management

## 📊 Supported Work Item Hierarchy

- **Epics** → Generates Features
- **Features** → Generates User Stories
- **User Stories** → Generates Tasks
- Supports type-specific fields (Success Criteria, Business Deliverables, Acceptance Criteria, etc.)
...
**Ready to transform your Agile workflow?** Install Task Genie today and experience the power of AI-assisted work item management across your entire Azure DevOps hierarchy.
